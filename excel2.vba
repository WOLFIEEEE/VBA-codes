Sub CreateTable()
    ...
    If Not FoundPageFlow Is Nothing Then
        ...
        TargetSheet.Cells(StartRow - 1, NextColumn - 1).Value = "Portal"
    ...
    Set tblRange = ws.Range(ws.Cells(tablestartrow, tablestartcol - 1), ws.Cells(tableendrow, tableendcol))
    ...
    If Not FoundCritical Is Nothing Then
        TargetSheet.Cells(StartRow - 1, NextColumn).Value = "Critical"
    ...
    If Not FoundHigh Is Nothing Then
        TargetSheet.Cells(StartRow - 1, NextColumn).Value = "High"
    ...
    If Not FoundMedium Is Nothing Then
        TargetSheet.Cells(StartRow - 1, NextColumn).Value = "Medium"
    ...
    If Not FoundLow Is Nothing Then
        TargetSheet.Cells(StartRow - 1, NextColumn).Value = "Low"
